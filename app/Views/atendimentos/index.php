...
<div class="card border-0 shadow-sm mb-4 d-none" id="cardFormulario">
    <div class="card-body">
        ...
        <form id="formAtendimento">
            <input type="hidden" name="usuario_id" value="<?= (int) ($_SESSION['usuario']['id'] ?? 0) ?>">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="descricao_atendimento" rows="3" required></textarea>
                </div>
            </div>
...
async function carregarCombos() {
    const [pessoasResp, tiposResp] = await Promise.all([
        ...
        AtendeLabApi.get('tipos_atendimento', 'listar'),
    ]);
