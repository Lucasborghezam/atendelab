...
<head>
    ...
    <!--
        api.js carregado no <head> sem defer para estar disponível
        imediatamente nos scripts inline das páginas.
    -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= $baseUrl ?>?controller=frontend&action=tiposAtendimentos">
                        Tipos
                    </a>
                </li>
                <li class="nav-item">
