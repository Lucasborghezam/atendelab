...
async function carregarTipos() {
    try {
        const tipos = AtendeLabApi.toList(await AtendeLabApi.get('tipos_atendimento', 'listar'));
...
async function editarTipo(id) {
    try {
        const tipo = AtendeLabApi.toObject(await AtendeLabApi.get('tipos_atendimento', 'buscar', { id }));
        novoTipo();
...
formTipo.addEventListener('submit', async event => {
    ...
    try {
        await AtendeLabApi.post('tipos_atendimento', acao, new FormData(formTipo));
...
async function inativarTipo(id) {
    ...
    try {
        await AtendeLabApi.post('tipos_atendimento', 'inativar', { id });
